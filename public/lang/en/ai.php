...
$string['aitoolsincoursedefaultdesc'] = 'When AI providers are configured, this will determine whether AI tools are available for courses by default. Teachers may change the default for their course afterward and also configure tool availability for individual activities.';
...
$string['enableaitoolsincoursedefault'] = 'Allow AI tools for courses';
