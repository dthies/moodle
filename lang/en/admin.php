...
$string['configconvertformat'] = 'If <i>latex</i>, <i>dvips</i> and <i>convert</i> or <i>dvisvgm</i> are available, the images are created using the specified format. If it is not, mimeTeX will be used and it will create GIF images.';
