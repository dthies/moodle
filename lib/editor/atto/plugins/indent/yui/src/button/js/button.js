...
Y.namespace('M.atto_indent').Button = Y.Base.create('button', Y.M.editor_atto.EditorPlugin, [], {
    ...
    outdent: function() {
        ...
        // IE does applies styling of blockquote to child element so these need to be removed.
        ...
        // Separate all the children in selected blockquotes because they misbehave when they are together with Chrome and Safari.
        ...
        // Clean up indents by combining neighboring blockquotes.
    ...
    /**
     * Merges neighboing blockquotes in the selection
