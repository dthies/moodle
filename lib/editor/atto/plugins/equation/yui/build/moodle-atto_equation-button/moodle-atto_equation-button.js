    ...
    TEMPLATES = {
        ...
        LIBRARY: '' +
            '<div class="{{CSS.LIBRARY}}">' +
                ...
                '</div>' +
            '</div>',
        PREVIEW: '<div describedby="{{elementid}}_cursorinfo" class="well well-small fullwidth {{CSS.EQUATION_PREVIEW}}" style="position: absolute; left: 0px; top: 0px" id="{{elementid}}_{{CSS.EQUATION_PREVIEW}}">{{content}}</div>'
    };
