...
EditorSelection.prototype = {
    ...
    setupSelectionWatchers: function() {
        ...
        //  Save the current selection after changed by events in editor.
        this.editor.on(['keyup', 'focus'], function(e) {
            Y.soon(Y.bind(this._hasSelectionChanged, this, e));
        }, this);

        // To capture both mouseup and touchend events, follow any gesturemoveend
        // only if gesturemovestart precedes it on the editor.
        this.editor.on('gesturemovestart', function() {
            Y.one('body').once('gesturemoveend', function(e) {
                Y.soon(Y.bind(this._hasSelectionChanged, this, e));
            }, {
                standAlone: true
            }, this);
