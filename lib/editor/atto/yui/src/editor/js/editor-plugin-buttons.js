...
EditorPluginButtons.prototype = {
     ...
     * @param {boolean} config.callbackDelayed A flag set true if callback should be delayed if selection is collapsed.
    ...
    _normalizeCallback: function(config, inheritFrom) {
        ...
        if (config.callbackDelayed) {
           config.callback = Y.rbind(this.applyFormat, this.get('host'), config.callback, this);
        }
