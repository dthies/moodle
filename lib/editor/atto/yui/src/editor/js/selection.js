...
EditorSelection.prototype = {
    ...
    setupSelectionWatchers: function() {
        ...
        this.editor.on(['keyup', 'focus', 'dragstart'], function(e) {
        ...
        this.editor.on('drop', function(e) {
                ...
                Y.soon(Y.bind(function(e) {
                    var selection = this.getSelection(),
                        ...
                        startOffset = 0,
                        container = Y.Node.create('<div>' + e._event.dataTransfer.getData('text/html') + '</div>');
                    if (!container.getHTML()) {
                        container = Y.Node.create('<div>' + e._event.dataTransfer.getData('text/plain') + '</div>');
                    }
