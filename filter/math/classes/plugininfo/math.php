 ...
 */
namespace filter_math\plugininfo;
...
class math extends base {
    ...
    public static function get_enabled_plugins() {
        ...
        $config = get_config('filter_math', 'disabledsubplugins');
        if ($config) {
        ...
        $enabled = array();
        $installed = core_component::get_plugin_list('math');
    ...
    public static function get_manage_url() {
        return new moodle_url('/admin/settings.php', array('section' => 'filtersettingsmath'));
    }

    public function get_settings_section_name() {
        return 'math'.$this->name.'settings';
    }
